...
<html lang="en">
  <head>
    ...
    <link href="/flatlab/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
    <link rel="stylesheet" href="/flatlab/css/owl.carousel.css" type="text/css">
  ...
  <section id="container" >
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="/flatlab/img/avatar-mini.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="/flatlab/img/avatar-mini2.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="/flatlab/img/avatar-mini3.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="/flatlab/img/avatar-mini4.jpg"></span>
                                    <span class="subject">
                      ...
                      <section class="panel">
                          <div class="panel-body">
                              <a href="#" class="task-thumb">
                                  <img src="/flatlab/img/avatar1.jpg" alt="">
                              </a>
                                          ...
                                          <div class="timeline-desk">
                                              <div class="panel">
                                                  <div class="panel-body">
                                                      ...
                                                      <div class="album">
                                                          <a href="#">
                                                              <img alt="" src="/flatlab/img/sm-img-1.jpg">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="/flatlab/img/sm-img-2.jpg">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="/flatlab/img/sm-img-3.jpg">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="/flatlab/img/sm-img-1.jpg">
                                                          </a>
                      ...
                      <section class="panel post-wrap pro-box">
                          ...
                          <aside class="post-highlight yellow v-align">
                              <div class="panel-body text-center">
                                  <div class="pro-thumb">
                                      <img src="/flatlab/img/ring.jpg" alt="">
                                  </div>
                              </div>
                          </aside>
                      </section>
                                  ...
                                  <div class="follower">
                                      <div class="panel-body">
                                          ...
                                          <div class="follow-ava">
                                              <img src="/flatlab/img/follower-avatar.jpg" alt="">
                                          </div>
                                      </div>
                                  </div>
      ...
      <div class="sb-slidebar sb-right sb-style-overlay">
          ...
          <ul class="quick-chat-list">
              <li class="online">
                  <div class="media">
                      <a href="#" class="pull-left media-thumb">
                          <img alt="" src="/flatlab/img/chat-avatar2.jpg" class="media-object">
                      </a>
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="pull-left media-thumb">
                          <img alt="" src="/flatlab/img/chat-avatar.jpg" class="media-object">
                      </a>
                      <div class="media-body">
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="pull-left media-thumb">
                          <img alt="" src="/flatlab/img/pro-ac-1.png" class="media-object">
                      </a>
                      <div class="media-body">
                          <div class="media-status">
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="pull-left media-thumb">
                          <img alt="" src="/flatlab/img/avatar1.jpg" class="media-object">
                      </a>
                      <div class="media-body">
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="pull-left media-thumb">
                          <img alt="" src="/flatlab/img/mail-avatar.jpg" class="media-object">
                      </a>
                      <div class="media-body">
                          <div class="media-status">
                              <span class=" badge bg-warning">7</span>
    ...
    <script src="/flatlab/js/sparkline-chart.js"></script>
    <script src="/flatlab/js/easy-pie-chart.js"></script>
    <script src="/flatlab/js/count.js"></script>
